  ...
  return (
    <div>
      <div className="p-6 mt-6 text-gray-800">
        <p className="text-3xl font-bold mt-9 p-8 text-center mb-4">FEATURED ATHLETES</p>
        
        <div className='flex gap-40 '>

        <img src={athleteImg1} className='h-[200px] rounded-2xl ml-12 w-88'/>
        <img src={athleteImg2} className='h-[200px] rounded-2xl  w-88'/>
        <img src={athleteImg3} className='h-[200px] rounded-2xl w-88'/>
          </div>
