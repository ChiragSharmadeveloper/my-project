...
const SubHeader = () => {
  return (
    ...
    <div className=''>
        <ul className="flex flex-wrap gap-4 p-1 mt-20 pl-20 font-bold text-black bg-gray-300 rounded-xl
                w-full sm:gap-4 sm:pl-2 md:gap-10 md:pl-6 lg:gap-22 lg:pl-6 lg:w-[1200px]" >
